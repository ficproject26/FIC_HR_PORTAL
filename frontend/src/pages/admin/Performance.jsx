                ...
                <tbody>
                  {data.map((hr, i) => (
                    <tr key={hr.id || i} style={{ borderBottom: `1px solid ${t.tableBorder}` }}
                      ...
                      <td style={{ padding: '14px', fontWeight: '600', color: t.textPrimary }}>{hr.total_calls}</td>
                      <td style={{ padding: '14px', color: t.textPrimary }}>{hr.total_followups}</td>
                      <td style={{ padding: '14px', color: t.textPrimary }}>{hr.total_contacted}</td>
                      <td style={{ padding: '14px' }}><span style={{ fontWeight: '700', color: '#10b981' }}>{hr.total_conversions}</span></td>
                      <td style={{ padding: '14px' }}>
                      ...
                      <td style={{ padding: '14px', color: t.textPrimary }}>{hr.assigned_leads}</td>
                    </tr>
                  ))}
                  {data.length === 0 && (
